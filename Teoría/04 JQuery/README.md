...
# Webs generales
- 
- [Página principal jQuery](https://jquery.com/)
- [Documentación jQuery](https://api.jquery.com/)

# Cursos
- [jQuery Didacticode](https://didacticode.com/curso/curso-de-jquery/)

# Apuntes
- [Apuntes de jQuery de W3Schools](https://www.w3schools.com/jquery/default.asp)

# Selectores de jQuery
- [Selectores - Documentación jQuery](https://api.jquery.com/category/selectors/)
